...
class TestPipelineService:
    ...
    async def test_get_all_pipelines(self, service: PipelineService, multiple_pipelines: list[Pipeline]):
    ...
    async def test_get_all_with_pagination(self, service: PipelineService, multiple_pipelines: list[Pipeline]):
        """Test pagination."""
    ...
    async def test_list_pipelines(self, service: PipelineService, multiple_pipelines: list[Pipeline]):
...
class TestRunService:
    ...
    async def test_get_by_pipeline(self, service: RunService, sample_run: Run, sample_pipeline: Pipeline):
...
class TestMetricsService:
    ...
    async def test_get_by_run(self, service: MetricsService, sample_metrics: Metrics, sample_run: Run):
...
class TestServiceIntegration:
    ...
    async def test_pipeline_run_relationship(self, test_db: Session, sample_pipeline: Pipeline, sample_run: Run):
    ...
    async def test_run_metrics_relationship(self, test_db: Session, sample_run: Run, sample_metrics: Metrics):
